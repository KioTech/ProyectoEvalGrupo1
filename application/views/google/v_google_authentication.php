<html>
<head>
	<link rel="stylesheet" type="text/css" href="content/assets/css/googleStyle.css">
...
<body>
	<div id="main">
		<div id="envelope">
			...
			<hr>
			<div id="content">
				<center><a href="<?php echo $authUrl; ?>"><img id="google_signin" src="content/vendor/google/images/google_login.jpg" width="100%" ></a></center>
			</div>
			<?php }else{ ?>
			<header id="info">
